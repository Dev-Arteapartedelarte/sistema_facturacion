...
# REST Framework - DESACTIVAR AUTENTICACIÓN PARA PRUEBAS
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [],  # ← Desactivado para pruebas
    "DEFAULT_PERMISSION_CLASSES": [
        "rest_framework.permissions.AllowAny",  # ← Permitir todo
    ],
}
